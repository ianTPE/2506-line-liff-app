...
export const MOCK_PRODUCTS: Product[] = [
  // 經典茶飲
  {
    ...
    image_url: '/images/products/pearl-milk-tea.jpg',
    rating: 4.5,
    review_count: 328,
    preparation_time: 8,
  ...
  },
  {
    ...
    image_url: '/images/products/winter-melon-lemon.jpg',
    rating: 4.3,
    review_count: 156,
    preparation_time: 5,
    availability_status: true,
  },
  {
    ...
    image_url: '/images/products/oolong-tea.jpg',
    rating: 4.4,
    review_count: 89,
    preparation_time: 3,
    availability_status: true,
  },
  {
    ...
    image_url: '/images/products/jasmine-green-tea.jpg',
    rating: 4.2,
    review_count: 203,
    preparation_time: 4,
    availability_status: true,
  ...
  // 季節限定
  {
    ...
    image_url: '/images/products/strawberry-shake.jpg',
    rating: 4.8,
    review_count: 234,
    preparation_time: 6,
    availability_status: true,
  },
  {
    ...
    image_url: '/images/products/mango-smoothie.jpg',
    rating: 4.7,
    review_count: 189,
    preparation_time: 7,
    availability_status: true,
  },
  {
    ...
    image_url: '/images/products/sakura-latte.jpg',
    rating: 4.9,
    review_count: 156,
    preparation_time: 8,
  ...
  },
  {
    ...
    image_url: '/images/products/scone.jpg',
    rating: 4.4,
    review_count: 78,
    preparation_time: 2,
    availability_status: true,
